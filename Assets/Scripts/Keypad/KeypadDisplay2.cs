...
public class KeypadDisplay2 : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        KeypadButton2.ButtonPressed += AddDigitToCodeSequence;
    ...
    {
        Player1Movement state = FindObjectOfType<Player1Movement>();
        state.currentState = Player1State.interact;
        keypadUI.SetActive(true);
    }
    public void ExitKeypadUI()
    {
        Player1Movement state = FindObjectOfType<Player1Movement>();
        state.currentState = Player1State.walk;
        keypadUI.SetActive(false);
    }
}
